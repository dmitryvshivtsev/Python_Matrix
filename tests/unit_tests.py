...
class TestMatrix(unittest.TestCase):
    ...
    def test_set_val(self):
        ...
        self.assertEqual(self.matrix_a[0, 1], self.matrix_b[0, 1])
    ...
    def test_sum(self):
        ...
        self.assertEqual(self.matrix_a[0, 0], 10)
        self.assertEqual(self.matrix_a[1, 1], 10)
    ...
    def test_sub(self):
        ...
        self.assertEqual(self.matrix_a[0, 0], 0)
